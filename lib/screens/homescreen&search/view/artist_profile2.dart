            ...
            child: Column(
              children: [
                Padding(
                     ...
                     CircleAvatar(
                      ...
                      userdetails.dpimage != null ?
                                  Padding(
                                    ...
                                    child: ClipOval( 
                                      child: Image(
                                        image: NetworkImage(userdetails.dpimage!)),
                                    ),
                                  ):
                                const Icon(CupertinoIcons.person_alt_circle_fill,size: 145,)   
                    ),
                    InkWell(
                      onTap: () {},
                      child:  CircleAvatar(
                 ...
                 normaltext(userdetails.domain!,const Color.fromARGB(255, 172, 172, 172), 13), 
                Padding(
