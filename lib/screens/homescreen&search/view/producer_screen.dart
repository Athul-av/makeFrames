      ...
      body: Consumer<AllUserProvider>(
        builder: (context, value, child) {
          if (value.producers.isEmpty) {
            return Center(
              child: boldtext("No producers", Colors.white, 15),
            );
          } else {
            return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          CircleAvatar(
                              ...
                              child: value.producers[index].dpimage != null
                                  ? Padding(
                                      padding: const EdgeInsets.only(top: 3.0),
                                      child: ClipOval(
                                        child: Image(
                                            image: NetworkImage(value
                                                .producers[index].dpimage!)),
                                      ),
                                    )
                                  : const Icon(
                          ...
                          normaltext(value.producers[index].domain!,
                              const Color.fromARGB(255, 140, 140, 140), 11),
                          ElevatedButton(
                              style: ButtonStyle(
                                  backgroundColor:
