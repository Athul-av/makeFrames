        ...
        builder: (context, value, child) {
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: 
              value.actors.isEmpty?
            Center(child:boldtext('no actors', Colors.white, 14),): 
              ListView.builder(
                  ...
                  itemBuilder: ((context, index) {
                    return Row(
                      children: [
                        ...
                        TopArtistsContainer(name: value.actors[index].firstName!,dpimage: value.actors[index].dpimage,userdata: value.actors[index],),
                        const SizedBox(
                          width: 7,
                        )
                      ],
                  ...
                  itemCount:  value.actors.length >5 ? 5 : value.actors.length  
                  )
            ),
          ),
          const Padding(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              Center(child:boldtext("no directors",Colors.white, 14),):
              ListView.builder(
                  scrollDirection: Axis.horizontal,
                  itemBuilder: ((context, index) {
                    return Row(
                      children: [
                        TopArtistsContainer(name: value.directors[index].firstName!,dpimage: value.directors[index].dpimage,userdata:value.directors[index] ),  
                        const SizedBox(
                          width: 7,
                        )
                      ],
                  ...
                  itemCount: 
                  value.directors.length >5?
                  5:value.directors.length 
                  ),
            ),
          ),
          const Padding(
          ...
          Padding(
            ...
            child: SizedBox(
              height: height(context, 0.2),
              child: 
              value.actress.isEmpty?
              Center(child: boldtext("no actress", Colors.white, 14),): 
              ListView.builder(
                  scrollDirection: Axis.horizontal,
                  itemBuilder: ((context, index) {
                    return Row(
                      children: [
                        TopArtistsContainer(name: value.actress[index].firstName!,dpimage: value.actress[index].dpimage,userdata: value.actress[index]), 
                         const SizedBox(
                          width: 7,
                        )
                      ],
                  ...
                  itemCount: value.actress.length > 5 ? 5 : value.actress.length), 
            ),
          ),
        ]);
        },
