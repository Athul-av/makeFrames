        ...
        builder: (context, value, child) {
            ...
            return Column(
              children: [
                ...
                Expanded(
                  child: 
                  value.searchdata!.isEmpty || value.searchdata ==null ?
                  Center(child: boldtext('No Artists', Colors.white, 15),):
                  Padding(
                              ...
                              children: [
                                 CircleAvatar(
                                  ...
                                  Padding(
                                    ...
                                    child: ClipOval( 
                                      child: Image(
                                        image: NetworkImage(value.searchdata![index].dpimage!)),
                                    ),
                                  ):
                                            ...
                                            RoundedRectangleBorder(
                                                borderRadius:
                                                    BorderRadius.circular(
                                                        12.0)))),
                                    onPressed: () {
                                      Navigator.of(context).push(MaterialPageRoute(builder: (_)=> ArtistProfileScreen2(userdetails: value.searchdata![index],))); 
                                    },
                                    child: const Text(
                                      'Show profile',
                                      style: TextStyle(
