...
AllStageShowRes value;
  ...
  //         ),
  //          ),
  //         Text(value.category!,style:const TextStyle(color: Color.fromARGB(255, 184, 184, 184),fontSize: 9),),
  //         ElevatedButton(
  //             style: ButtonStyle(
  ...
  //             onPressed: () {
  //               Navigator.of(context).push(MaterialPageRoute(builder: (_)=> StageShowDetails(value: value,))); 
  //             },
  //             child: const Text(
  //               ' More details ',
  //               style: TextStyle(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  ...
                  style:const TextStyle(
                       fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white),),
                       Text(value.category! ,style:const TextStyle(color: Color.fromARGB(255, 184, 184, 184),fontSize: 10)) 
                  ],
                ),
              )
            ],
