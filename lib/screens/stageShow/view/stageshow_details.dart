...
class StageShowDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Provider.of<AllStageShowProvider>(context, listen: false)
        .videoplayerinitialize(value.vdoFile!);
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 8, right: 8),
            child: Align(
                child: normaltext(value.category!,
                    const Color.fromARGB(255, 174, 174, 174), 12)),
          ),
          hsizedbox(context, 0.032),
          Padding(
            padding: const EdgeInsets.only(left: 8, right: 8),
            child: normaltext(value.description!,
                const Color.fromARGB(255, 214, 214, 214), 15),
          ),
          Padding(
            ...
            child: Align(
              ...
              child: ShapeOfView(
                ...
                child: Container(
                  ...
                  color: color1(),
                  child: Center(
                      child: boldtext('₹ ${value.amount}', Colors.white, 14)),
                ),
              ),
            ),
          ),
